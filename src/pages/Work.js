...
import leetcard from "../images/leetcard-banner.png";
    ...
    <Container class="wrapper">
      <Row className="galleryP">
        ...
        <div class="wrapper">
          ...
          <div class="media">
            <div class="layer">
              <Nav.Link as={NavLink} to="/work/likee-xdownloader">
                + UX/UI Design
              </Nav.Link>
            </div>
          ...
          <div class="media">
            <div class="layer">
              <Nav.Link as={NavLink} to="/work/half-byte">
                + Board Game Design
              </Nav.Link>
            </div>
        ...
        {/* <Container class="wrapper">
      <Row className="galleryP">
        <h1 className="sectionTitle mb-3">/gallery</h1>
        <div class="wrapper">
          <div class="media">
            <div class="layer">
